...
#Hpos = genfromtxt('Structs/H.dat').tolist()
x = soapPy.get_periodic_soap_locals(atoms_c, Hpos, myAlphas, myBetas, rCut=10.0, NradBas=5, Lmax=5) 
print("soap for each atom in structure")
y = soapPy.get_periodic_soap_structure(atoms, myAlphas, myBetas, 10.0, NradBas=5, Lmax=5)
