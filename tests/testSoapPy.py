...
myAlphas, myBetas = genBasis.getBasisFunc(8.0, 5)
a = datetime.datetime.now()
x = soapPy.get_soap_locals(atoms, Hpos, myAlphas, myBetas, rCutHard=8.0, NradBas=5, Lmax=1) #rCutSoft = rCutHard - 3.0
b = datetime.datetime.now()
c = b - a
c.microseconds
print("soap for each atom in structure")
y = soapPy.get_soap_structure(atoms, myAlphas, myBetas, rCutHard=8.0, NradBas=5, Lmax=9) #rCutSoft = rCutHard - 3.0
