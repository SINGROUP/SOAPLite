  ...
  for(int i = 0; i < Hs; i++){
    for(int j = 0; j < Ts; j++){
      for(int k = 0; k < Ns; k++){
        for(int kd = 0; kd < Ns; kd++){
          soapMat[NsNsLmaxTs*i+ NsNsLmax*j+ 0 +Ns*k+kd] 
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 2*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 3*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 4*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 5*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 6*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 7*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 8*NsNs + Ns*k+kd] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        for(int k = 0; k < Ns; k++){
          for(int kd = 0; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 9*NsNs + Ns*k+kd] =
