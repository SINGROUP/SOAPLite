...
//================================================================
void getAlphaBeta(float* aOa, float* bOa, float* alphas, float* betas, int Ns,int lMax){
...
void getP(float* soapMat, float* Cnnd, int Ns, int Ts, int Hs, int lMax){
  ...
  for(int i = 0; i < Hs*NsNs*(lMax+1); i++){soapMat[i] = 0.0;}
  ...
  for(int i = 0; i < Hs; i++){
    for(int j = 0; j < Ts; j++){
      ...
      for(int k = 0; k < Ns; k++){
        for(int kd = k; kd < Ns; kd++){
          soapMat[NsNsLmaxTs*i+ NsNsLmax*j+ 0 +shiftN]
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 2*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 3*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 4*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 5*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 6*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 7*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 8*NsNs + shiftN] =
    ...
    for(int i = 0; i < Hs; i++){
      for(int j = 0; j < Ts; j++){
        ...
        for(int k = 0; k < Ns; k++){
          for(int kd = k; kd < Ns; kd++){
            soapMat[NsNsLmaxTs*i+NsNsLmax*j+ 9*NsNs + shiftN] =
...
//===========================================================================================
//===========================================================================================
int soap(float* c, float* Apos,float* Hpos,float* alphas,float* betas, int* typeNs, float rCut, int totalAN,int Nt,int Ns, int lMax, int Hs);
int soap(float* c, float* Apos,float* Hpos, float* alphas,float* betas, int* typeNs, float rCut, int totalAN,int Nt,int Ns, int lMax, int Hs){
...
//  float* soapMat = (float*) malloc(Hs*Nt*(Ns*(Ns+1))/2*(lMax+1)*sizeof(float));
//  float* soapMat = (float*) malloc(10000000000);
