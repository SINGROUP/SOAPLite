...
// Getting R, Theta and Phi rescaled for the Gaull-Legendre quadrature
  ...
  vec printOut = zeros<vec>(typesN*radialN*radialN*lMax);
...
for(int bigI = 0; bigI < hydrogenPos.n_rows; bigI++){
  mpiBigI = bigI*world_size + world_rank;
 if(hydrogenPos.n_rows>mpiBigI){

// Adding Hydrogen at the end

  coord_H.row(coord_H.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_He.row(coord_He.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Li.row(coord_Li.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Be.row(coord_Be.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_B.row(coord_B.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_C.row(coord_C.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_N.row(coord_N.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_O.row(coord_O.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_F.row(coord_F.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ne.row(coord_Ne.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Na.row(coord_Na.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Mg.row(coord_Mg.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Al.row(coord_Al.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Si.row(coord_Si.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_P.row(coord_P.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_S.row(coord_S.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Cl.row(coord_Cl.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ar.row(coord_Ar.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_K.row(coord_K.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ca.row(coord_Ca.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Sc.row(coord_Sc.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ti.row(coord_Ti.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_V.row(coord_V.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Cr.row(coord_Cr.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Mn.row(coord_Mn.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Fe.row(coord_Fe.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Co.row(coord_Co.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ni.row(coord_Ni.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Cu.row(coord_Cu.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Zn.row(coord_Zn.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ga.row(coord_Ga.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ge.row(coord_Ge.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_As.row(coord_As.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Se.row(coord_Se.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Br.row(coord_Br.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Kr.row(coord_Kr.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Rb.row(coord_Rb.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Sr.row(coord_Sr.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Y.row(coord_Y.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Zr.row(coord_Zr.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Nb.row(coord_Nb.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Mo.row(coord_Mo.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Tc.row(coord_Tc.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ru.row(coord_Ru.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Rh.row(coord_Rh.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pd.row(coord_Pd.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ag.row(coord_Ag.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Cd.row(coord_Cd.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_In.row(coord_In.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Sn.row(coord_Sn.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Sb.row(coord_Sb.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Te.row(coord_Te.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_I.row(coord_I.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Xe.row(coord_Xe.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Cs.row(coord_Cs.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ba.row(coord_Ba.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_La.row(coord_La.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ce.row(coord_Ce.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pr.row(coord_Pr.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Nd.row(coord_Nd.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pm.row(coord_Pm.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Sm.row(coord_Sm.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Eu.row(coord_Eu.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Gd.row(coord_Gd.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Tb.row(coord_Tb.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Dy.row(coord_Dy.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ho.row(coord_Ho.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Er.row(coord_Er.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Tm.row(coord_Tm.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Yb.row(coord_Yb.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Lu.row(coord_Lu.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Hf.row(coord_Hf.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ta.row(coord_Ta.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_W.row(coord_W.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Re.row(coord_Re.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Os.row(coord_Os.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ir.row(coord_Ir.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pt.row(coord_Pt.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Au.row(coord_Au.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Hg.row(coord_Hg.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Tl.row(coord_Tl.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pb.row(coord_Pb.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Bi.row(coord_Bi.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Po.row(coord_Po.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_At.row(coord_At.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Rn.row(coord_Rn.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Fr.row(coord_Fr.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ra.row(coord_Ra.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Ac.row(coord_Ac.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Th.row(coord_Th.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pa.row(coord_Pa.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_U.row(coord_U.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Np.row(coord_Np.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coord_Pu.row(coord_Pu.n_rows - 1) = hydrogenPos.row(mpiBigI);

//  coord_a.row(coord_a.n_rows - 1) = hydrogenPos.row(mpiBigI);
//  coord_b.row(coord_b.n_rows - 1) = hydrogenPos.row(mpiBigI);
  coordH.row(coordH.n_rows - 1) = hydrogenPos.row(mpiBigI);
